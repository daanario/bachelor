...
def bertrand_simulation_forced_deviation(alpha, delta, T, prices):
    ...
    while t < T:
        ...
        t += 1
    return p_table, avg_profs1, avg_profs2
#Doesnt work when jitted, could be solved but I didn't bother so don't jit this function
def bertrand_simulation_convergence(alpha, delta, T, prices):
    ...
    while t < T:
        ...
        # Helps keeping track of taking the difference of the right Q_matrices
        if toggle == True:
            counter+=1
        ...
        if counter ==2:
            ...
            # Sum the differences into a single value
        ...
        j = tmp
        t += 1
    return p_table, Q_norm_array1, Q_norm_array2